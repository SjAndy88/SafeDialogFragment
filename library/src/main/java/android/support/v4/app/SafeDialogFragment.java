 ...
 */
public class SafeDialogFragment extends Fragment
    ...
    void dismissInternal(boolean allowStateLoss, boolean now) {
        if (mDismissed) {
            return;
        }
        mDismissed = true;
     ...
     * Dialog.setCancelable(boolean)}, because android.support.v4.app.SafeDialogFragment needs to change
     ...
     * class.
     *
     * <p><em>Note: android.support.v4.app.SafeDialogFragment own the {@link Dialog#setOnCancelListener
        ...
        if (view != null) {
            if (view.getParent() != null) {
                throw new IllegalStateException(
                        "android.support.v4.app.SafeDialogFragment can not be attached to a container view");
            }
